      ...
      <div className="relative site-container">
        <div className="max-w-4xl center-x text-center">
            ...
            <div className="flex justify-center mb-14">
              <div className="relative w-48 h-48 md:w-56 md:h-56">
                ...
                <svg className="absolute inset-0 w-full h-full animate-sigil-rotate" style={{ animationDuration: "20s" }} viewBox="0 0 230 230">
                  ...
                  <text className="fill-crimson/35" style={{ fontSize: "9px", letterSpacing: "4px", fontFamily: "monospace" }}>
          ...
          <ScrollReveal animation="up" delay={0.4}>
            <p className="font-body text-base md:text-lg text-bone/70 leading-relaxed max-w-lg center-x mb-12">
          ...
          <ScrollReveal animation="up" delay={0.8}>
            <div className="mt-12 flex items-center justify-center gap-6">
              <a
                ...
                className="group flex items-center gap-2 font-mono text-[10px] tracking-[0.2em] text-ash/50 hover:text-bone/70 transition-all duration-500 uppercase"
              >
